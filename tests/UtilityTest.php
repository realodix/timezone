...
class UtilityTest extends TestCase
{
    ...
    #[PHPUnit\TestWith(['UTC'])]
    #[PHPUnit\TestWith(['America/New_York'])]
    public function testIsTimezoneValid($timezone)
    {
        $this->assertTrue(Util::isTimezone($timezone));
    }

    #[PHPUnit\TestWith(['GMT'])]
    #[PHPUnit\TestWith(['utc'])]
    #[PHPUnit\TestWith(['Invalid/Timezone'])]
    public function testIsTimezoneInvalid($timezone)
    {
